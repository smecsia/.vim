var jslintOpts = {
	...
	predef: ['document','setTimeout','clearTimeout','setInterval','clearInterval','parseToInt','parseToFloat','window','dojo', 'dijit', 'app', 'kley', 'console', 'dojox','dor','doh','mui','medhub','mbe','medapp','prompt'],
